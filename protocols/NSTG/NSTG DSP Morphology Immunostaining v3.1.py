...
metadata = {
    'protocolName': 'Nanostring GeoMx DSP Morphology immunostaining v3.1',
...
### VERAO VAR NAME='Device type' TYPE=CHOICE OPTIONS=['omni_stainer_s12_slides']
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    if primary_staining:
        apply_and_incubate(protocol, pipette, primary_ab_wells,     "primary Ab"    ,sample_chambers,   ab_volume,     num_reps, primary_ab_incubation                                    )
