...
def run(protocol: protocol_api.ProtocolContext):
    ...
    H2O2wash1_wells = black_96.columns()[0]
    H2O2wash2_wells = black_96.columns()[1]
    avidinblock_wells = black_96.columns()[2]
    biotinblock_wells = black_96.columns()[3]
    probe_wells = black_96.columns()[4]
    amp1_wells = black_96.columns()[5]
    amp2_wells = black_96.columns()[6]
    amp3_wells = black_96.columns()[7]
    HRPC1_wells = black_96.columns()[8]
    substrate_wells = black_96.columns()[9]
    DAB_wells = black_96.columns()[10]
    ...
    for i in range(len(wellslist)):
        print(i)
        washSamples(pipette_300, H2O2wash1_wells[i], H2O2wash1_wells[i], 2, 1, extra_bottom_gap + 18, keep_tip=True)
    ...
    for i in range(len(wellslist)):
        print(i)
        washSamples(pipette_300, H2O2wash2_wells[i], H2O2wash2_wells[i], 2, 1, extra_bottom_gap + 18, keep_tip=True)
    pipette_300.drop_tip()
    ...
    for i in range(len(wellslist)):
        print(i)
        washSamples(pipette_300, avidinblock_wells[i], avidinblock_wells[i], 2, 1, extra_bottom_gap + 18, keep_tip=True)
    pipette_300.drop_tip()
    ...
    for i in range(len(wellslist)):
        print(i)
        washSamples(pipette_300, biotinblock_wells[i], biotinblock_wells[i], 2, 1, extra_bottom_gap + 18, keep_tip=True)
    pipette_300.drop_tip()
    ...
    for i in range(len(wellslist)):
        print(i)
        washSamples(pipette_300, probe_wells[i], probe_wells[i], 2, 1, extra_bottom_gap + 18, keep_tip=True)
    ...
    for i in range(len(wellslist)):
        print(i)
        washSamples(pipette_300, amp1_wells[i], amp1_wells[i], 2, 1, extra_bottom_gap + 18, keep_tip=True)
    pipette_300.drop_tip()
    ...
    for i in range(len(wellslist)):
        print(i)
        washSamples(pipette_300, amp2_wells[i], amp2_wells[i], 2, 1, extra_bottom_gap + 18, keep_tip=True)
    pipette_300.drop_tip()
    ...
    for i in range(len(wellslist)):
        print(i)
        washSamples(pipette_300, amp3_wells[i], amp3_wells[i], 2, 1, extra_bottom_gap + 18, keep_tip=True)
    pipette_300.drop_tip()
    ...
    for i in range(len(wellslist)):
        print(i)
        washSamples(pipette_300, HRPC1_wells[i], HRPC1_wells[i], 2, 1, extra_bottom_gap + 18, keep_tip=True)
    pipette_300.drop_tip()
