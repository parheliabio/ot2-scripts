...
metadata = {
    'protocolName': 'ACD multiplexed v2 ColdPlate',
...
storage_hold_set_time_minutes = 0
...
def run(protocol: protocol_api.ProtocolContext):
   ...
   #Setting up ColdPlate temperature module and omni-stainer module
    ...
    # may need to call temp_mod creation in protocol
    ...
    if avidin_and_biotin_block:
        ...
        puncture_wells(pipette_300, avidinblock_wells)
        ...
        puncture_wells(pipette_300, biotinblock_wells)
