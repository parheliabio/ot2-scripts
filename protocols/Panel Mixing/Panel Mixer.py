...
### END VERAO GLOBAL
metadata = {
    'protocolName': '10x Visium CytAssist prep, Day 1 and 2, v5',
...
### VERAO VAR NAME='Room temp (C)' TYPE=NUMBER LBOUND=20 UBOUND=25 DECIMAL=FALSE
room_temp = 22
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    buffers.PBS = buffer_wells['A4']
    buffers.Eosin = buffer_wells['A12']
